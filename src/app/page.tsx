  ...
  return (
    <div className='flex max-w-6xl mx-auto flex-col py-2 min-h-screen items-center justify-center'>
      ...
      <div className="flex justify-center space-x-4">
        <a href="" className="bg-white rounded-xl text-black font-medium px-4 py-3 sm:mt-10 mt-8 hover:bg-gray-100 border">Learn how it&apos;s built</a>
        <Link href="/revive" className="bg-black rounded-xl text-white font-medium px-4 py-3 sm:mt-10 mt-8 hover:bg-black/80">Revive your Images</Link>
      </div>
        ...
        <div className="flex flex-col space-y-10 mt-4 mb-16">
          <div className="flex sm:space-x-2 sm:flex-row flex-col">
            <div>
              ...
              <Image alt="Original Image" src="/srk-blur.jpg" className="w-96 h-96 rounded-2xl object-cover" width={400} height={400}/>
            </div>
            <div>
              <h2 className="mb-1 font-medium text-lg">Revived Image</h2>
              <Image alt="Revived Image" src="/srk-blur.jpg" className="w-96 h-96 rounded-2xl object-cover" width={400} height={400}/>
            </div>
          </div>
        </div>
      </div>
